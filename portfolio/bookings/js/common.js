$(function() {
    ...
    // $('.dropdown-header:not(.dropdown-city)').bind('mousewheel DOMMouseScroll', function(e) {
    //     var scrollTo = null;
    ...
    $('.search-city input:checkbox').change(function() {
        if ($('.search-city input:checkbox').is(":checked")) {
            $(this).closest('body').find('.main-nav__item-submit').addClass('open')
        }
    });
    ...
    $('.search-city input:checkbox').change(function() {
        if (!$('.search-city input:checkbox').is(":checked")) {
            $(this).closest('body').find('.main-nav__item-submit').removeClass('open')
        }
    });
    ...
    // $(".seo-button").click(function(e) {
    //     e.preventDefault()
    //     var el = $('.seotext-hidden'),
    //         curHeight = el.height(),
    ...
    $('.city-init').click(function() {
        $(this).toggleClass('active');
        $(this).closest('.dropdown-mobile-wrap').toggleClass('active');
        $('.city-tab').toggle();
